...
const Furniture = () => {
  ...
  return (
    <div id="furniture" className="py-10 bg-gray-100">
      <div className="container mx-auto px-4">
        {/* Header section */}
        <div className="mb-12 text-center">
          <p className="text-sm text-emerald-400">Discover Our Furniture Collection</p>
          <h1 className="text-3xl font-bold">Furniture</h1>
          <p className="text-xs text-gray-400">High-quality pieces for every home.</p>
        </div>
