...
const HomeDecors = () => {
  ...
  return (
    <div id="home-decor" className="py-10 bg-gray-100">
      <div className="container mx-auto px-4">
        {/* Header section */}
        <div className="mb-14 text-center">
          <p className="text-sm text-emerald-400">Enhance Your Home</p>
          <h1 className="text-3xl font-bold">Home Decors</h1>
          <p className="text-xs text-gray-400">Stylish accessories for every room.</p>
        </div>
